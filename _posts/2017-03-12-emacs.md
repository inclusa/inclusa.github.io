...
1. Canvia a altre buffer sol·liciant el nom. Si es proporcioan el nom d'un buffer no obert, es crea un amb eixe nom i canvia a ell.

`C-x b`

2. Selecciona altra finestraa

`C-x o`

3. Borra la finestra seleccionada

`C-x 0`

4. Borra todas les finestres excepte la seleccionada

`C-x  1`

5. Selecciona un buffer en una finestra nova

`C-x 4 b`

6. Visita un fitxer i situa un buffer en altra finestra, que es converteix en la seleccionada

`C-x 4 f`

7. Borra la finestra seleccionada y tanca, mata el buffer que contenia
